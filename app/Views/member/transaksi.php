    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <?php foreach ($cart as $c) { ?>
                <div class="card" style="width: 18rem;">
                    <img src="gambar/<?= $c['gambar'] ?>" class="card-img-top" alt="produk" style="width: 175px; height: 200px">
                    <div class="card-body">
                        <h5 class="card-title text-dark"><?= $c['judul'] ?></h5>
                        <p class="card-text">Deskripsi : <?= $c['deskripsi_cart'] ?></p>
                        <p class="card-text">Jumlah : <?= $c['jumlah'] ?></p>
                        <p class="card-text text-success"><b>Rp.<?= $c['subtotal'] ?></b></p>
        ...
        <div class="col-md-6">
            ...
            <form action="<?= base_url('transaksi/bayar') ?>" method="POST">
                ...
                <input type="hidden" id="subtotal" value="<?= $total ?>" name="subtotal">
